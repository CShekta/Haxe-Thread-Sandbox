...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public hx::Object
{
	...
	public:
		...
		static ::Dynamic onThreadCreated_dyn();

		static void warmTortillas();
		static ::Dynamic warmTortillas_dyn();

		static void cookTortillas();
		static ::Dynamic cookTortillas_dyn();

		static void prepareTacos();
		static ::Dynamic prepareTacos_dyn();
